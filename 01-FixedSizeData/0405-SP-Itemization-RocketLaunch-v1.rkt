...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 0405-SP-Itemization-RocketLaunch-v1) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")))))
; 04.05 Sample Problem - Itemization
;
; NOTE: this version includes the revised 'show' function from Ex 51
;       and the development of the 'launch' the addition of a 'main'
;
;

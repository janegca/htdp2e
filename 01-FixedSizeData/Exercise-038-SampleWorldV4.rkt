...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname Exercise-038-SampleWorldV4) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")))))
; Exercise 38. 
...
; [NOTE: a world sate of zero was equivalent to the middle of the car, 
;        added an X-DISPLACEMENT constant to equate 0 with - 1/2 car width
;        and modified 'render' to use the new value].

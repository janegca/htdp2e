...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname Exercise-102c-CheckEditor) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")))))
; Exercise 73. 
;
...
(check-expect (editor-or-not? (run "hello")) true)
(check-expect (editor-or-not? "hello") false) 

(define (editor-or-not? eds)
  (cond
    [(editor? eds) true]
    [else false]))

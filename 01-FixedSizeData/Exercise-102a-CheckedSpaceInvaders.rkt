...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname Exercise-102a-CheckedSpaceInvaders) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")))))
; Exercise 88. 
;
...
(check-expect (sigs-or-not? (make-aim (make-posn 5 50) 
                                      (make-tank 10 5)))   true)
(check-expect (sigs-or-not? (make-fired (make-posn 50 50)
                                        (make-tank 50 1)

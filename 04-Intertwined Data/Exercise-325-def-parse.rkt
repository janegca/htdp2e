...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname Exercise-325-def-parse) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
; Exercise 325. 
; 

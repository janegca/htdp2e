...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname Exercise-273-blue-eyed-child-in-forest) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
; Exercise 273. 
; 
; Reformulate the data definition for FF with the List-of abstraction. Now do
; so for the signature of blue-eyed-child-in-forest?. Finally, define

...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname Exercise-312-eval-bool-expressions) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
; Exercise 311
;

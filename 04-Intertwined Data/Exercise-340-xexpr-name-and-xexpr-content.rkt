...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname Exercise-340-xexpr-name-and-xexpr-content) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
; Exercise 340.
;
; Design the functions xexpr-name and xexpr-content.
...
; re-written to take advantage of pattern matching

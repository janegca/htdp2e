...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname Exercise-144-FiringShotsRev2) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")))))
; Exercise 144. 
; 
; If you run main, press the space bar (fire a shot), and wait for a good 
; amount of time, the shot disappears from the canvas. When you shut down 
; the world canvas, however, the result is a world that still contains this 
; invisible shot.
;
...
; the canvas. Hint You may wish to consider the design of an auxiliary
...
(define (tock w) 
  (cond    [(empty? w) '()]   
           [(cons? w)
            (cond [(< (sub1 (first w)) 0) (tock (rest w))]

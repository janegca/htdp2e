...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname 1301-SP-WordGameV2) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")))))
; 13.01 - Sample Problem - Word Games v 2
;
; Given a word, find (all possible) words that are made up from some letters. 
; For example “cat” also spells “act.”
;
; After solving Exercise 181
